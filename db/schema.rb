...
ActiveRecord::Schema.define(version: 2023_01_24_102304) do
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.string "mail_subscription", default: "subscribed"
    t.string "email_campaigns", default: [], array: true
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.string "mail_status", default: "unread"
